...
public class OrderController {
    ...
    public ResponseEntity<OrderDTO> getOrderById(@PathVariable Long id,
            @AuthenticationPrincipal UserPrincipal currentUser) {
        OrderDTO order = orderQueryService.getOrderByIdForUser(id, currentUser.getId());
        return ResponseEntity.ok(order);
    }
    ...
    public ResponseEntity<ShippingInfoDTO> getOrderShipping(@PathVariable Long id,
            @AuthenticationPrincipal UserPrincipal currentUser) {
        ShippingInfoDTO shippingInfo = orderQueryService.getOrderShippingInfoForUser(id, currentUser.getId());
